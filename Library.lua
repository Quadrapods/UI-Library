...
return function(Window)
    ...
    Window.Size = Get.Utilities:CheckType(Window.Size, "UDim2") or UDim2.new(0, 496, 0, 496)
    ...
    function Window:AddTab(Tab)
        ...
        function Tab:AddDivider(Divider)
            ...
            Divider.Text = Get.Utilities:CheckType(Divider.Text, "string") or nil
            Divider.Side = Get.Utilities:CheckType(Divider.Side, "string") or nil
        ...
        function Tab:AddButton(Button)
            ...
            Button.Callback = Get.Utilities:CheckType(Button.Callback, "function") or function()
                    print("Hello World!")
                end
            local LocalButton =
                Get.Button(Get.Utilities:ChooseTabSide(Button.Side, LocalTab), LocalWindow, Window, Get, Button)
            return Button
        end
        function Tab:AddToggle(Toggle)
            ...
            local LocalToggle =
                Get.Toggle(Get.Utilities:ChooseTabSide(Toggle.Side, LocalTab), LocalWindow, Window, Get, Toggle)
            return Toggle
        end
        function Tab:AddSlider(Slider)
            ...
            local LocalSlider =
                Get.Slider(Get.Utilities:ChooseTabSide(Slider.Side, LocalTab), LocalWindow, Window, Get, Slider)
            return Slider
        end
        function Tab:AddTextbox(Textbox)
            ...
            Textbox.Text = Get.Utilities:CheckType(Textbox.Text, "string") or ""
            ...
            local LocalSlider =
                Get.Textbox(Get.Utilities:ChooseTabSide(Textbox.Side, LocalTab), LocalWindow, Window, Get, Textbox)
            return Textbox
        end
        function Tab:AddBind(Bind)
            ...
            Bind.Blacklist =
                Get.Utilities:CheckType(Bind.Blacklist, "table") or
                {"W", "A", "S", "D", "Slash", "Tab", "Backspace", "Escape", "Space", "Delete", "Unknown", "Backquote"}
            local LocalBind =
                Get.Keybind(Get.Utilities:ChooseTabSide(Bind.Side, LocalTab), LocalWindow, Window, Get, Bind)
            return Bind
        end
        function Tab:AddDropdown(Dropdown)
            ...
            local LocalDropdown =
                Get.Dropdown(Get.Utilities:ChooseTabSide(Dropdown.Side, LocalTab), LocalWindow, Window, Get, Dropdown)
            return Dropdown
        end
        function Tab:AddColorpicker(Colorpicker)
            ...
            local LocalColorpicker =
                Get.Colorpicker(
                Get.Utilities:ChooseTabSide(Colorpicker.Side, LocalTab),
                LocalWindow,
                Window,
                Get,
                Colorpicker
        ...
        function Tab:AddSection(Section)
            ...
            function Section:AddDivider(Divider)
                Divider = Get.Utilities:CheckType(Divider, "table") or {}
                Divider.Text = Get.Utilities:CheckType(Divider.Text, "string") or nil
