...
return function(Window)
    ...
    function Window:AddTab(Tab)
        ...
        function Tab:AddButton(Button)
            ...
            local LocalButton =
                Get.Button(Get.Utilities:ChooseTabSide(Button.Side, LocalTab), LocalScreen, Window, Get, Button)
            return Button
        end
        function Tab:AddToggle(Toggle)
            ...
            local LocalToggle =
                Get.Toggle(Get.Utilities:ChooseTabSide(Toggle.Side, LocalTab), LocalScreen, Window, Get, Toggle)
            return Toggle
        end
        function Tab:AddSlider(Slider)
            ...
            local LocalSlider =
                Get.Slider(Get.Utilities:ChooseTabSide(Slider.Side, LocalTab), LocalScreen, Window, Get, Slider)
            return Slider
        end
        function Tab:AddTextbox(Textbox)
            ...
            local LocalSlider =
                Get.Textbox(Get.Utilities:ChooseTabSide(Textbox.Side, LocalTab), LocalScreen, Window, Get, Textbox)
            return Textbox
        end
        function Tab:AddBind(Bind)
            ...
            local LocalBind =
                Get.Keybind(Get.Utilities:ChooseTabSide(Bind.Side, LocalTab), LocalScreen, Window, Get, Bind)
            return Bind
        end
        function Tab:AddDropdown(Dropdown)
            ...
            local LocalDropdown =
                Get.Dropdown(Get.Utilities:ChooseTabSide(Dropdown.Side, LocalTab), LocalScreen, Window, Get, Dropdown)
            return Dropdown
        end
