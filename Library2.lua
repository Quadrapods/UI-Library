...
do
    ...
    function Signal.new()
        ...
        -- clean up memory.
        self._bindableEvent.Event:Connect(
            function(key)
    ...
    services.InputService.InputEnded:Connect(
        function(input, gpe)
    ...
    services.InputService.InputChanged:Connect(
        function(input, gpe)
            for obj, signals in next, objsignals do
                if
                    objexists[obj] and obj.Visible and
                        (signals.MouseEnter or signals.MouseMove or signals.InputChanged or signals.MouseLeave)
                 then
                    if ismouseover(obj) then
    ...
    services.InputService.InputBegan:Connect(
        function(input, gpe)
            for obj, signals in next, objsignals do
                if objexists[obj] then
                    if obj.Visible then
                        if ismouseover(obj) and not mouseoverhighersquare(obj) then
                            ...
                            if
                                input.UserInputType == Enum.UserInputType.MouseButton1 and
                                    (not mouseoverhighersquare(obj) or obj.Transparency == 0)
                             then
        ...
        if shape == 'Square' then
                        ...
                        if docontinue then
                            if amount > 0 then
                                ...
                                for i, object in next, objchildren[self] do
                                    if
                                        istouching(
                                            object.Position + Vector2.new(0, poschange),
                                            object.Size,
                                            mtobjs[self].Position,
                                            mtobjs[self].Size
                                        )
                                ...
                                local diff =
                                    (Vector2.new(0, mtobjs[self].Position.Y) -
                                    Vector2.new(0, (closestobj.Position.Y + poschange + objpaddings[self]))).magnitude

                                if custompropertygets[mtobjs[self]]('ClipsDescendants') then
                                    for i, object in next, objchildren[self] do
                                        if
                                            not istouching(
                                                object.Position + Vector2.new(0, poschange - diff + objpaddings[self]),
                                                object.Size,
                                                mtobjs[self].Position,
                                                mtobjs[self].Size
                                            )
                                ...
                                for i, object in next, objchildren[self] do
                                    childrenposupdates[objmts[object]](
                                        objmts[object],
                                        object.Position + Vector2.new(0, poschange - diff + objpaddings[self])
                                    )
                                    object.Position =
            ...
            listfunc = function(self, padding)
                ...
                for i, object in next, objchildren[self] do
                    ...
                    local newpos =
                        mtobjs[self].Position +
                        Vector2.new(0, listcontents[self] + (#listchildren[self] == 1 and 0 or padding))
                    ...
                    listcontents[self] =
                        listcontents[self] + object.Size.Y + (#listchildren[self] == 1 and 0 or padding)
                end
            ...
            {exists = true},
            {
                    ...
                    if k == 'Remove' then
                        return function(self)
                            ...
                            if customproperties.Parent and listobjs[customproperties.Parent] then
                                ...
                                listcontents[customproperties.Parent] =
                                    listcontents[customproperties.Parent] - listadds[customproperties.Parent][obj]

                                for i, object in next, objchildren[customproperties.Parent] do
                                    if i > objindex then
                                        object.Position =
                                            object.Position - Vector2.new(0, listadds[customproperties.Parent][obj])
                                    end
                                end

                                if table.find(listchildren[customproperties.Parent], obj) then
                                    table.remove(
                                        listchildren[customproperties.Parent],
                                        table.find(listchildren[customproperties.Parent], obj)
                                    )
                                end

                                if table.find(objchildren[customproperties.Parent], obj) then
                                    table.remove(
                                        objchildren[customproperties.Parent],
                                        table.find(objchildren[customproperties.Parent], obj)
                                    )
                                    table.remove(
                                        listindexes[customproperties.Parent],
                                        table.find(objchildren[customproperties.Parent], obj)
                                    )
                                end
                            end
                ...
                __newindex = function(self, k, v)
                    ...
                    changechildrenvis = function(parent, vis)
                        if objchildren[parent] then
                            for _, object in next, objchildren[parent] do
                                if
                                    (custompropertygets[mtobjs[parent]]('ClipsDescendants') and
                                        not istouching(
                                            object.Position,
                                            object.Size,
                                            mtobjs[parent].Position,
                                            mtobjs[parent].Size
                                        ))
                                 then
                                    object.Visible = false
                    ...
                    if k == 'Visible' then
                        ...
                        if
                            customproperties.Parent and
                                (not mtobjs[customproperties.Parent].Visible or
                                    (custompropertygets[mtobjs[customproperties.Parent]]('ClipsDescendants') and
                                        not istouching(
                                            obj.Position,
                                            obj.Size,
                                            mtobjs[customproperties.Parent].Position,
                                            mtobjs[customproperties.Parent].Size
                                        )))
                         then
                            v = false
                    ...
                    if k == 'ClipsDescendants' then
                        ...
                        for _, object in next, objchildren[self] do
                            object.Visible =
                                v and
                                (istouching(object.Position, object.Size, obj.Position, obj.Size) and
                                    objvisibles[object] or
                                    false) or
                                objvisibles[object]
                        end
                        ...
                        if typeof(v) == 'UDim2' then
                            ...
                            if customproperties.Parent then
                                ...
                                if listobjs[customproperties.Parent] then
                                    ...
                                    v =
                                        mtobjs[customproperties.Parent].Position +
                                        udim2tovector2(v, mtobjs[customproperties.Parent].Size)
                                end
                            else
                            ...
                            if
                                customproperties.Parent and
                                    custompropertygets[mtobjs[customproperties.Parent]]('ClipsDescendants')
                             then
                                obj.Visible =
                                    istouching(
                                    v,
                    ...
                    if k == 'Size' then
                        if typeof(v) == 'UDim2' then
                            ...
                            if customproperties.Parent and listobjs[customproperties.Parent] then
                                ...
                                listadds[customproperties.Parent][obj] =
                                    listadds[customproperties.Parent][obj] + sizediff

                                for i, object in next, objchildren[customproperties.Parent] do
                                    if i > objindex then
                                        object.Position = object.Position + Vector2.new(0, sizediff)
                                        listindexes[customproperties.Parent][i] =
                                            listindexes[customproperties.Parent][i] + sizediff
                                    end
                                end
                            end
                            ...
                            if customproperties.ClipsDescendants then
                                for _, object in next, objchildren[self] do
                                    object.Visible =
                                        istouching(object.Position, object.Size, obj.Position, v) and
                                        objvisibles[object] or
                                        false
                                end
                            end
                            ...
                            if customproperties.Parent and listobjs[customproperties.Parent] then
                                ...
                                for i, object in next, objchildren[customproperties.Parent] do
                                    if i > objindex then
                                        object.Position = object.Position + Vector2.new(0, sizediff)
                                        listcontents[customproperties.Parent] =
                                            listcontents[customproperties.Parent] + sizediff
                                        listindexes[customproperties.Parent][i] =
                                            listindexes[customproperties.Parent][i] + sizediff
                                    end
                                end
                    ...
                    if k == 'Parent' then
                        ...
                        if udim2sizeobjs[obj] then
                            ...
                            if custompropertygets[mtobjs[v]]('ClipsDescendants') then
                                obj.Visible =
                                    istouching(obj.Position, newsize, mtobjs[v].Position, mtobjs[v].Size) and
                                    objvisibles[obj] or
                                    false
                            end
                        ...
                        if listobjs[v] then
                            ...
                            table.insert(
                                listindexes[v],
                                listcontents[v] + (#listchildren[v] == 1 and 0 or objpaddings[v])
                            )

                            local newpos =
                                Vector2.new(0, listcontents[v] + (#listchildren[v] == 1 and 0 or objpaddings[v]))
                            ...
                            listcontents[v] =
                                listcontents[v] + obj.Size.Y + (#listchildren[v] == 1 and 0 or objpaddings[v])
                        ...
                        if udim2posobjs[obj] then
                            ...
                            if custompropertygets[mtobjs[v]]('ClipsDescendants') then
                                obj.Visible =
                                    istouching(newpos, obj.Size, mtobjs[v].Position, mtobjs[v].Size) and
                                    objvisibles[obj] or
                                    false
                            end
                        ...
                        if custompropertygets[mtobjs[v]]('ClipsDescendants') then
                            obj.Visible =
                                istouching(obj.Position, obj.Size, mtobjs[v].Position, mtobjs[v].Size) and
                                objvisibles[obj] or
                                false
                        end
...
function utility.dragify(object, dragoutline)
    ...
    utility.connect(
        services.InputService.InputChanged,
        function(input)
    ...
    utility.connect(
        services.InputService.InputEnded,
        function(input)
...
library.gradient =
    decode(
    ''
)
    ...
    box.MouseButton1Click:Connect(
        function()
            ...
            if not connection then
                connection =
                    utility.connect(
                    services.InputService.InputBegan,
                    function(input)
                        if input.UserInputType == Enum.UserInputType.Keyboard then
                            if input.KeyCode ~= Enum.KeyCode.Backspace then
                                ...
                                if table.find(allowedcharacters, str) then
                                    ...
                                    if
                                        not services.InputService:IsKeyDown(Enum.KeyCode.RightShift) and
                                            not services.InputService:IsKeyDown(Enum.KeyCode.LeftShift)
                                     then
                                        ...
                                        coroutine.wrap(
                                            function()
                                                ...
                                                while services.InputService:IsKeyDown(input.KeyCode) and
                                                    currentqueue == keyqueue do
                                                    text.Text = text.Text .. str:lower()
                                                    callback(text.Text)
...
function library.createdropdown(
    ...
    dropdown.MouseButton1Up:Connect(
        function()
            dropdown.Color =
                mouseover and utility.changecolor(library.theme['Object Background'], 3) or
            ...
            function()
                if max then
                    if table.find(chosen, option) then
                        ...
                        value.Text =
                            #chosen == 0 and 'NONE' or table.concat(textchosen, ', ') .. (cutobject and ', ...' or '')
...
function library.createcolorpicker(default, defaultalpha, parent, count, flag, callback)
    ...
    local alphaicon =
        ...
        'Image',
        {
            ...
            Parent = icon,
            Data = decode(
                'iVBORw0KGgoAAAANSUhEUgAAABIAAAAKBAMAAABLZROSAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAGUExURb+/v////5nD/3QAAAAJcEhZcwAADsMAAA7DAcdvqGQAAAAVSURBVBjTY2AQhEIkliAWSLY6QQYAknwC7Za+1vYAAAAASUVORK5CYII='
            )
        }
    )
    ...
    library.createbox(
        ...
        function(str)
            ...
            if amount == 2 then
                ...
                local r, g, b =
                    math.clamp(values[1]:gsub('%D+', ''), 0, 255),
                    math.clamp(values[2]:gsub('%D+', ''), 0, 255),
                    math.clamp(values[3]:gsub('%D+', ''), 0, 255)
                ...
                text.Text =
                    string.format(
                    '%s, %s, %s',
                    math.round(hsv.R * 255),
                    math.round(hsv.G * 255),
                    math.round(hsv.B * 255)
                )
            end
        end
    )
    ...
    local function updatesatval(input)
        ...
        local sizeY =
            1 - math.clamp(((input.Position.Y - saturation.AbsolutePosition.Y) + 36) / saturation.AbsoluteSize.Y, 0, 1)
        local posY =
            math.clamp(
    ...
    local function updatehue(input)
        ...
        local posX =
            math.clamp(
            ((input.Position.X - hueframe.AbsolutePosition.X) / hueframe.AbsoluteSize.X) * hueframe.AbsoluteSize.X,
            0,
            hueframe.AbsoluteSize.X - 2
        )
    ...
    local function updatealpha(input)
        local sizeY =
            1 - math.clamp(((input.Position.Y - alphaframe.AbsolutePosition.Y) + 36) / alphaframe.AbsoluteSize.Y, 0, 1)
        local posY =
            math.clamp(
...
function library.createkeybind(default, parent, blacklist, flag, callback, offset)
    ...
    utility.connect(
        ...
        function(input)
            if
                not binding and (input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == key) or
...
function library:Load(options)
    ...
    local windowtypes =
        utility.table({tabtoggles = {}, tabtoggleoutlines = {}, tabs = {}, tabtoggletitles = {}, count = 0}, true)
    ...
    function windowtypes:Tab(name)
        ...
        tabtoggle.MouseEnter:Connect(
            function()
                mouseover = true
                tabtoggle.Color =
                    tab.Visible == true and utility.changecolor(library.theme['Tab Toggle Background'], 3) or
                    utility.changecolor(library.theme['Tab Background'], 3)
            end
        )
        ...
        tabtoggle.MouseLeave:Connect(
            function()
                mouseover = false
                tabtoggle.Color =
                    tab.Visible == true and library.theme['Tab Toggle Background'] or library.theme['Tab Background']
            end
        )

        tabtoggle.MouseButton1Down:Connect(
            function()
                tabtoggle.Color =
                    tab.Visible == true and utility.changecolor(library.theme['Tab Toggle Background'], 6) or
                    utility.changecolor(library.theme['Tab Background'], 6)
            end
        )
        ...
        tabtoggle.MouseButton1Click:Connect(
            function()
                ...
                tabtoggle.Color =
                    mouseover and utility.changecolor(library.theme['Tab Toggle Background'], 3) or
                    utility.changecolor(library.theme['Tab Background'], 3)
        ...
        function tabtypes:Section(options)
            ...
            function sectiontypes:Toggle(options)
                ...
                local function setstate()
                    ...
                    icon.Color =
                        toggled and library.theme['Accent'] or
                        (mouseover and utility.changecolor(library.theme['Object Background'], 3) or
                            library.theme['Object Background'])
                ...
                function toggletypes:Keybind(options)
                    ...
                    return library.createkeybind(
                        ...
                        blacklist,
                        flag,
                        mode == 'toggle' and newcallback or callback,
                        -2
                    )
                end
            ...
            function sectiontypes:ColorPicker(options)
                ...
                local colorpickertypes =
                    library.createcolorpicker(default, defaultalpha, holder, colorpickers, flag, callback)
